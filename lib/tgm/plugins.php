...
function tt_register_required_plugins() {
  ...
  $plugins = array(
    ...
    array(
		...
		array(
	    'name'                => 'Realty - Membership Packages And Invoices',
	    'slug'                => 'realty-membership-and-invoices',
	    'source'              => get_stylesheet_directory() . '/lib/plugins/realty-membership-and-invoices.zip',
			'version'             => '1.0',
	    'required'            => false,
		),
