...
class widget_property_search extends WP_Widget {
	...
	function widget_property_search() {
		$widget_ops = array( 
			...
			'description' => __( 'Property Search', 'tt' ),
			'panels_icon' => 'icon-themetrail',
		);
		parent::__construct( 'widget_property_search', __( 'Realty - Property Search', 'tt' ), $widget_ops );
	}
  ...
  function form($instance) {
	  ...
	  if ( isset( $instance[ 'title' ] ) ) {
		...
		<p><?php _e( 'As defined under: Appearance > Theme Options > Property Search', 'tt' ); ?></p>
