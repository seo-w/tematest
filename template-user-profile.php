	...
	<?php the_content();?>
		...
		<div id="main-content" class="content-box primary-tooltips">
			...
			<div class="row">
				...
				<form id="profile-edit" enctype="multipart/form-data" method="post" class="col-md-8">
					
					<?php echo '<h3 style="text-transform: none;">' . __( 'Welcome', 'tt' ) . ' ' . $userdata->user_login . '!</h3>'; ?>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<div class="form-group" style="margin-bottom: 1em">
								<label for="user_image" class="hide"><?php _e( 'Profile Image', 'tt' ); ?> <i class="fa fa-info-circle" data-toggle="tooltip" title="<?php _e( '(JPEG, JPG, PNG, GIF. Max: 5 MB)', 'tt' ); ?>"></i></label>
						...
						<div class="form-group">
							<label for="subscribed_package"><?php _e( 'Subscribed Plan: ', 'tt' ); ?></label>
							<label for="subscribed_package"><?php _e( $package_title, 'tt' ); ?></label>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="mobile_phone_number"><?php _e( 'Mobile', 'tt' ); ?></label>
							...
							<div class="form-group">
								<label for="fax_number"><?php _e( 'Fax', 'tt' ); ?></label>
						...
						<div class="col-sm-8">
							...
							<div class="form-group">
								<label for="office_phone_number"><?php _e( 'Phone', 'tt' ); ?></label>
							...
							<div class="form-group">
								<label>&nbsp;</label>
								<input type="submit" name="submit" id="submit-profile-update" class="form-control btn-block" value="<?php _e( 'Save Changes', 'tt' ); ?>" />
							</div>
